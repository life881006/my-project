<template>
  <div id class="headerNav">
    <el-col :xs="16" :sm="16" :md="16" :lg="16">{{user.unit.name}}</el-col>
    <el-col :xs="8" :sm="8" :md="8" :lg="8" class="pull-right">
      ...
      <el-dropdown class="functionalIcon headBtn" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item @click.native="gotoModifyPwd()">
            <i class="el-icon-edit"></i>修改密码
          </el-dropdown-item>
          <el-dropdown-item @click.native="unitChange()">
            <i class="el-icon-edit"></i>单位设置
          </el-dropdown-item>
          <el-dropdown-item @click.native="gotoBindSchoolClassSubject()">
            <i class="el-icon-edit"></i>我的任课
          </el-dropdown-item>
          <div class="clear"></div>
          <el-dropdown-item @click.native="openHelpDocument()">
      ...
      <div class="functionalIcon">
        <a @click="exit" content="退出">
          <i class="el-icon-erp-exit el-icon-big"></i>
        </a>
      </div>
    </el-col>
  </div>
