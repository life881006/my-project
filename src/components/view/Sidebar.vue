<template>
  <div id="menu">
    <el-scrollbar class="scrollbar-wrapper">
      ...
      >
        <el-submenu
          v-for="module in asideModules"
          :key="module.id"
          ref="module.id"
          :index="module.serialNumber+''"
        >
          ...
          <el-menu-item-group v-if="module.name!='网站群'">
            <el-submenu
              v-for="modulePItem in module.children"
              :key="modulePItem.id"
              ref="modulePItem.id"
              :index="modulePItem.serialNumber+''"
            >
              <template slot="title">
              ...
              <el-menu-item-group>
                ...
                >{{moduleItem.itemName}}</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu-item-group>
        </el-submenu>
...
export default {
  ...
  data: function () {
    return {
      isCollapse: this.sideBarWidth < 1440,
      asideModules: []
    }
  },
