<template>
	<el-col :xs="24" :sm="24" :md="24" :lg="24" id="moduleClickHistory">
		<span class="visitorTag" v-for="item in routerHistory">
			<router-link class="routerTags" :to="{path:'/'+item.routerPath}">{{item.moduleItemName}}</router-link>
...
<style>
	...
	#moduleClickHistory>.visitorTag i:hover{background-color:#eee;color:#333}
</style>